 		...
 		if (isdirectory) {
 			...
 			fs.exists(path.substring(2), (res) => {
 				if (res) {
 					...
 					try {
 						fs.writeFile(path.substring(2), '{"schema":"","debug":true,"debugIp":"192.168.12.153","entry":"app/index.js","preload":[],"splash":"splash","static":{"umeng":{"ios":{"appkey":""},"android":{"appkey":""}}},"platform":{"wx":{"appkey":"","appsecret":""},"qq":{"appkey":"","appsecret":""},"weibo":{"appkey":"","appsecret":"","url":""}}}', {
 							flag: 'w',
 							encoding: 'utf-8',
 							mode: '07777'
 						}, function (err) {
